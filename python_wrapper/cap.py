...
import wrapper_settings as settings
...
class Cap(object):
    ...
    def __init__(self, api_key):
        ...
        self.header = {'AUTHORIZATION': 'Token {}'.format(api_key)}
    ...
    def search_cases(self, search_term="", jurisdiction="", court="", decision_date_min="", decision_date_max="",
        ...
        if search_term:
            url_queries.append("search=%s" % search_term)
    ...
    def download_to_csv(self, search_results, filename):
        ...
        with open(filename, "w") as csvfile:
            fieldnames = ["id", "name", "name_abbreviation", "decision_date", "court_id", "court_name", 
                          "parties", "judges", "attorneys", "citations", "url", "head", "body"]
            ...
            while True:
                for case in current_page["results"]:
                    case_data = {
                        ...
                        "parties": str(case["casebody"]["data"]["parties"]),
    ...
    def download_mltpl_courts(self, search_results, filename):
        ...
        with open(filename, "w", encoding='utf-8') as csvfile:
            fieldnames = ["id", "name", "name_abbreviation", "decision_date", "court_id", "court_name", 
                          "court_slug", "parties", "judges", "attorneys", "citations", "url", "head", "body"]
            writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
